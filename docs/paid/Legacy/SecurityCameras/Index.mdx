...
sidebar_position: 1
---
import { LegacyButton, ButtonFlex } from '@site/src/components/Custom/LegacyButton'
...
Security Cameras is a realistic CCTV simulator in FiveM. It uses two items ( by default ) to place security cameras and to manage them.
